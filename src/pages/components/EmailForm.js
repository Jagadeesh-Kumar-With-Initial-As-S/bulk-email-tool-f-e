...
const submitbtn = async () => {
    ...
    <div>
        ...
        <form>
            ...
            <input type="email" placeholder="You man enter email address on here. For example : hufutogaloge@gotgel.org,jagadeesh_2k17@proton.me" style={{width: "550px"}} id="email" required />
            <br />
            <br />
