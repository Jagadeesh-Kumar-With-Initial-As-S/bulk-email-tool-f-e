...
const submitbtn = async () => {
    ...
    <div>
        ...
        <form>
            ...
            <input type="email" placeholder="You man enter email address on here. For example : hufutogaloge@gotgel.org,jagadeesh_2k17@proton.me" style={{width: "850px"}} id="email" required />
            <br />
            <br />
            ...
            <textarea placeholder="You may enter the message on here." id="message" style={{width: "850px"}} rows="7" required></textarea>
            <br />
            <br />
